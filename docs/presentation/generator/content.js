...
const slides = [
  // ---------------- 1
  { kind: "title", kicker: "Serverless on Cloudlet", title: "From Knative to the Portal", sub: "What we built, and why.", meta: "Team review · September 2026",
  ...
  // ---------------- 2
  { kind: "content", chapter: 0, kicker: "Agenda", title: "Four chapters",
    lines: ["01  Foundations: serverless, Knative, the Operator", "02  The API: contract, mTLS, two regions", "03  Functions: buildpacks, kpack, build controller", "04  Portal and cloudlet-apis: what comes next"],
    visual: { kind: "glyph", text: "01 → 04", sub: "fourteen questions, one platform" },
  ...
  // ---------------- 3
  { kind: "content", chapter: 1, kicker: "Chapter 01 · Foundations", title: "What is serverless?",
  ...
  // ---------------- 4
  { kind: "content", chapter: 1, kicker: "Chapter 01 · Foundations", title: "What is Knative?",
  ...
  // ---------------- 5
  { kind: "content", chapter: 1, kicker: "Chapter 01 · Foundations", title: "The OpenShift Serverless Operator",
  ...
  // ---------------- 6
  { kind: "content", chapter: 1, kicker: "Chapter 01 · Foundations", title: "Why the Operator",
  ...
  // ---------------- 7
  { kind: "section", chapter: 2, num: "02", title: "The API", sub: "One HTTP call, a workload on every cluster." },
  // ---------------- 8
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "One call, every cluster",
  ...
  // ---------------- 9
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "The endpoint structure",
  ...
  // ---------------- 10
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "Anatomy of a workload",
  ...
  // ---------------- 11
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "Talking to the cluster",
  ...
  // ---------------- 12
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "Active/active, two regions",
  ...
  // ---------------- 13
  { kind: "content", chapter: 2, kicker: "Chapter 02 · The API", title: "The tenant controller",
  ...
  // ---------------- 14
  { kind: "section", chapter: 3, num: "03", title: "Functions & builds", sub: "'Here is my repo' hides a build." },
  // ---------------- 15
  { kind: "content", chapter: 3, kicker: "Chapter 03 · Functions & builds", title: "Why functions are different",
  ...
  // ---------------- 16
  { kind: "content", chapter: 3, kicker: "Chapter 03 · Functions & builds", title: "Buildpacks and kpack",
  ...
  // ---------------- 17
  { kind: "content", chapter: 3, kicker: "Chapter 03 · Functions & builds", title: "A build, step by step",
  ...
  // ---------------- 18
  { kind: "content", chapter: 3, kicker: "Chapter 03 · Functions & builds", title: "The build controller",
  ...
  // ---------------- 19
  { kind: "section", chapter: 4, num: "04", title: "Portal & the future", sub: "A console, and a library for the next API." },
  // ---------------- 20
  { kind: "content", chapter: 4, kicker: "Chapter 04 · Portal & the future", title: "How the portal wires it",
  ...
  // ---------------- 21
  { kind: "content", chapter: 4, kicker: "Chapter 04 · Portal & the future", title: "A console, not a Serverless UI",
  ...
  // ---------------- 22
  { kind: "content", chapter: 4, kicker: "Chapter 04 · Portal & the future", title: "cloudlet-apis: start at step five",
